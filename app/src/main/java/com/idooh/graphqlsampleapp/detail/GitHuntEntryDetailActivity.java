package com.idooh.graphqlsampleapp.detail;
...
import com.idooh.graphqlsampleapp.api.EntryDetailQuery;
...
/**
 * Created by Mary Sabio on 08/03/2018.
 */
...
public class GitHuntEntryDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        description = findViewById(R.id.tv_repository_description);
        postedBy = findViewById(R.id.tv_posted_by);
